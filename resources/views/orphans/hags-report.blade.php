@include('components.header', ['page_title' => " خدمات الحج و العمرة للايتام "])
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid mt-4">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-style">
            ...
            <li  class="breadcrumb-item active">خدمات الحج و العمرة للايتام</li>
          </ol>
        </nav>
      ...
      <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center pl-3">
          <h3>خدمات الحج و العمرة للايتام</h3>
              ...
              <div class="col-1">
                ...
                <div class="form-group">
                    <select name="type" class="form-select">
                      <option value="all">حج  عمرة</option>
      ...
      {{ $orphans->withQueryString()->appends(['searching' => 1])->links('vendor.pagination.bootstrap-5') }}
        ...
        @else
           ...
           <div class="text-center p-5 mx-auto my-5">
              <h3>قم بالبحث عن  اسم  اليتيم  او الشهيد في حقل البحث لعرضه, او اضغط على عرض كل  الخدمات المقدم للايتام</h3>
            </div>
