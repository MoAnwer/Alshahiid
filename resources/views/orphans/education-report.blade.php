@include('components.header', ['page_title' => "خدمات التعليم  للايتام"])
      ...
      <div class="container-fluid mt-4">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-style">
            ...
            <li  class="breadcrumb-item active">خدمات التعليم  للايتام</li>
          </ol>
        </nav>
                ...
                <div class="form-group">
                    <select name="type" class="form-select">
                      <option value="all"  @selected(request('type') == "all")>الكل</option>
                        <option value="زي و أدوات" @selected(request('type') == 'زي و أدوات')>زي و أدوات</option>
                        <option value="رسوم دراسية" @selected(request('type') == 'رسوم دراسية')>رسوم دراسية</option>
                        <option value="تأهيل مهني" @selected(request('type') == 'تأهيل مهني')>تأهيل مهني</option>
                        <option value="تأهيل نسوي" @selected(request('type') == 'تأهيل نسوي')>تأهيل نسوي</option>
                        <option value="تكريم متفوقين" @selected(request('type') == 'تكريم متفوقين')>تكريم متفوقين</option>
                        <option value="دراسات عليا" @selected(request('type') == 'دراسات عليا')>دراسات عليا</option>
                        <option value="إعانات طلاب" @selected(request('type') == 'إعانات طلاب')>إعانات طلاب</option>
                        <option value="دورات رفع المستويات" @selected(request('type') == 'دورات رفع المستويات')>دورات رفع المستويات</option>
                    </select>
                </div>
            </div>
