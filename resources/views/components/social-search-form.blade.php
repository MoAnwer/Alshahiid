          ...
          <form action="{{ URL::current() }}" method="GET">
              ...
              <div class="col-2">
                ...
                <div class="form-group">
                    <select name="search" class="form-select">
                      ...
                      <option value="project_name" @selected(request('search') == 'project_name')>اسم الخدمة</option>
            ...
            <div class="col-1">
                ...
                <div class="form-group">
                    <select name="status" class="form-select">
                      <option value="all">الكل</option>
                      <option value="يعمل" @selected(request('status') == 'يعمل')>يعمل</option>
                      <option value="لا يعمل" @selected(request('status') == 'لا يعمل')>لا يعمل</option>
                    </select>
                </div>
            </div>
              ...
              <div class="col-1">
                  <label>السنة: </label>
                  <div class="form-group">
                    <input type="number" class="py-4 form-control" max="2100" min="1900" step="1" name="year" value="{{ request('year') ?? date('Y') }}" />
                  </div>
                </div>
              ...
              <div class="col-1">
                  <label>الشهر: </label>
                  <div class="form-group">
                    <input type="number" class="py-4 form-control" min="1" max="12" step="1" name="month" value="{{ request('month') ??  date('m')  }}" />
                  </div>
                </div>
